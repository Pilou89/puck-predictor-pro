        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h3 className="font-semibold flex items-center gap-2">
              Paris JOUEURS
              <Badge className="bg-primary/20 text-primary border-primary/30 border text-xs">IA + Manuel</Badge>
            </h3>
            <p className="text-xs text-muted-foreground">1-3 SAFE • 1-3 FUN • Super Combo (saisie cotes)</p>
          </div>
        </div>
        <Button onClick={fetchPlayerSuggestions} disabled={isLoading} size="sm" variant="outline" className="gap-2">
            ...
            {playersWithOdds.length < 4 ? (
              ...
              superCombo && (
                <div className="p-4 rounded-lg border-2 border-accent/30 bg-accent/5">
                  <div className="flex items-center gap-2 mb-3">
                    <Badge className="bg-accent text-accent-foreground">Système {superCombo.systemType}</Badge>
                    <span className="text-xs text-muted-foreground">{superCombo.combinationsCount} combinaisons</span>
                  </div>
                  ...
                  <div className="grid grid-cols-3 gap-3 text-center mb-3">
                    ...
                    <div>
                      ...
                      <p
                        className={`font-bold ${superCombo.minRecoveryPercent >= 80 ? "text-success" : "text-warning"}`}
                      >
